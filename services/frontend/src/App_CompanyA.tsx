...
// Company configuration - this will be different for each company
const COMPANY_CONFIG = {
  companyCode: 'COMP_A', // This will be COMP_B, COMP_C for other companies
  companyName: 'Company Alpha',
  backendUrl: 'http://localhost:5001', // This will be 5002, 5003 for other companies
  primaryColor: '#25D366', // WhatsApp green for Company A
